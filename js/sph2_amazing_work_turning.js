        ...
        amazingWorkCards.forEach(function (card) {
            ...
            switch (index) {
                case 0:
                    ...
                    if (workTab.classList.contains("work_list_active") && card.dataset.additionalPictures != "true") {
                ...
                case 1:
                    ...
                    loadMoreBtnClicksCounter = 0;
                    if (card.dataset.workType == "Graphic Design" && workTab.classList.contains("work_list_active") && card.dataset.additionalPictures !== "true") {
                        card.classList.add("active");
                        card.style.transform = "";
                ...
                case 2:
                    loadMoreBtnClicksCounter = 0;
                    if (card.dataset.workType == "Web Design" && workTab.classList.contains("work_list_active") && card.dataset.additionalPictures !== "true") {
                        card.classList.add("active");
                        card.style.transform = "";
                    }
                ...
                case 3:
                    loadMoreBtnClicksCounter = 0;
                    if (card.dataset.workType == "Landing Pages" && workTab.classList.contains("work_list_active" ) && card.dataset.additionalPictures !== "true") {
                        card.classList.add("active");
                        card.style.transform = "";
                    }
                    else { card.classList.remove("active"); }
                ...
                case 4:
                    loadMoreBtnClicksCounter = 0;
                    if (card.dataset.workType == "Wordpress" && workTab.classList.contains("work_list_active" ) && card.dataset.additionalPictures !== "true") {
                        card.classList.add("active");
                        card.style.transform = "";
                    }
                    else { card.classList.remove("active"); }
...
amazingWorkCards.forEach(function (card) {
    ...
    card.addEventListener("click", (event) => {
        ...
        backSideCopy.querySelector(".amazing_work_type").textContent = event.currentTarget.dataset.workType;
     ...
     if (event.currentTarget.style.transform != "rotateY(180deg)") {
        event.currentTarget.style.transform = "rotateY(180deg)";
            ...
            let elementToDelete = event.currentTarget.querySelector(".image_back_side");
            setTimeout( () => {elementToDelete.remove();} ,800);
...
function toggleMoreWorkImages(additionalWorkTypeCards) {
    additionalWorkTypeCards.forEach(function (additinalCard, index) {
        ...
        if ( additinalCard.dataset.additionalPictures === "true" && loadMoreBtnClicksCounter == 1 && additinalCard.dataset.workType === activeWorkTab.dataset.workType) {
            imagesCounter = 0
            setTimeout(() => setTimeout(() => additinalCard.classList.add("active"), 150 * (++imagesCounter)), 3000)
            loadMoreBtn.classList.add("loadMoreBtn_hide")
        ...
        else if ( additinalCard.dataset.additionalPictures == "true" && loadMoreBtnClicksCounter == 1 && index <= 27 && activeWorkTab.dataset.workType === "All") {
            imagesCounter = 0;
            setTimeout(() => setTimeout(() => additinalCard.classList.add("active"), 150 * (++imagesCounter)), 3000)
          
        }

        else if ( additinalCard.dataset.additionalPictures == "true" && loadMoreBtnClicksCounter == 2 && index > 27 && activeWorkTab.dataset.workType === "All") {
            imagesCounter = 0;
            setTimeout(() => setTimeout(() => additinalCard.classList.add("active"), 150 * (++imagesCounter)), 3000)
            loadMoreBtn.classList.add("loadMoreBtn_hide")
        }
        ...
        // else if ( additinalCard.dataset.additionalPictures == "true" && loadMoreBtnClicksCounter == 2 && additinalCard.dataset.workType === activeWorkTab.dataset.workType) {
        //     imagesCounter = 0;
        //     setTimeout(() => setTimeout(() => additinalCard.classList.add("active"), 150 * (++imagesCounter)), 3000)
        //     loadMoreBtn.classList.add("loadMoreBtn_hide")
        // }
